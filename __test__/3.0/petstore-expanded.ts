...
export interface SwaggerApi{
   ...
   */
  get(url: "/pets", options: {path?: {}, query: {
   ...
   */
  post(url: "/pets", options: {body: NewPet, timeout?: number} & IDefaultOptions): Promise<Pet>
  ...
  delete(url: "/pets/{id}", options: {path: {
    id: number
  }, query?: {}, header?: {}, body?: any, timeout?: number} & IDefaultOptions): Promise<Error>
}
